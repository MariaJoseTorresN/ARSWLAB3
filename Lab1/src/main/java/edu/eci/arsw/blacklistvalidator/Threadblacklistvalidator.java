...
public class Threadblacklistvalidator extends Thread{
	...
	Threadblacklistvalidator(String ipaddress,int min,int max,HostBlacklistsDataSourceFacade skds,AtomicInteger ocurrencesCount,AtomicInteger checkedListsCount){
		this.min = min;
		this.max=max;
